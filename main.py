...
def button_enter():
    ...
    if flag_mode == 0:
        ...
        # 使用交通機関
        doc.paragraphs[25].text = "　　　　　　　　　使用交通機関　　　" + en3_1.get()
        # 区間出力
        doc.paragraphs[26].text = "　　　　　　　　　区間　　　　　　　" + en3_2.get()
        # 金額出力
        doc.paragraphs[27].text = "　　　　　　　　　金額　　　　　　　" + en3_3.get() + "円"
        # 内訳出力
        doc.paragraphs[28].text = "　　　　　　　　　内訳　　　　　　　" + en3_4.get()
        # 購入予定日出力
        doc.paragraphs[29].insert_paragraph_before("　　　　　　　　　購入予定日　　　　" + en3_5.get())
        # 購入理由
        doc.paragraphs[30].insert_paragraph_before("　　　　　　　　　購入理由　　　　　" + te3_1.get("1.0", "end-1c"))
    elif flag_mode == 3:
        # 車種出力
        doc.paragraphs[25].text = "　　　　　　　　　　　車種　　　　　" + en4_1.get()
        # 見積金額出力
        doc.paragraphs[26].text = "　　　　　　　　　見積金額　　　　　\\" + en4_2.get() + "-"
        # ガソリン代出力
        doc.paragraphs[27].text = "　　　　　　　　　ガソリン代　　　　\\" + en4_3.get() + "-"
        # 高速道路代出力
        doc.paragraphs[28].text = "　　　　　　　　　高速道路代　　　　\\" + en4_4.get() + "-"
        # 使用予定日出力
        doc.paragraphs[29].insert_paragraph_before("　　　　　　　　　使用予定日　　　　" + en4_5.get())
        # 使用経路出力
        doc.paragraphs[30].insert_paragraph_before("　　　　　　　　　使用経路（往復）　" + en4_6.get())
        # 使用理由
...
def button_change1():
    ...
    te0_1.insert("1.0", "○○代を予算内から使用することを要望いたします。")
...
def button_change2():
    ...
    flag_mode = 1
    te0_1.delete("1.0", "end")
    te0_1.insert("1.0", "○○への移動として交通費を予算内から使用することを要望いたします。")
...
def button_change4():
    ...
    flag_mode = 3
    te0_1.delete("1.0", "end")
    te0_1.insert("1.0", "○○のため以下の要領でレンタカーを使用することを要望いたします。")
    bu_change1.configure(fg_color="white", hover_color="whitesmoke", text_color="black", state="normal")
    bu_change2.configure(fg_color="white", hover_color="whitesmoke", state="normal")
    bu_change3.configure(fg_color="white", hover_color="whitesmoke", state="normal")
...
scrollable_frame = ctk.CTkFrame(canvas, fg_color=main_bg_color, width=800, height=1350)
...
cb0_5 = ctk.CTkCheckBox(fr_body, text="三部会五委員会が郵送代・飲食費を交際費として使用したい場合", font=font_body)
...
te0_1 = ctk.CTkTextbox(fr_body, width=650, height=75, font=font_body)
te0_1.insert("1.0", "○○代を予算内から使用することを要望いたします。")
...
la3_1 = ctk.CTkLabel(fr_mode3, text="使用する交通機関名（路線名等）を入力してください。", font=font_body)
en3_1 = ctk.CTkEntry(fr_mode3, width=250, placeholder_text="例：常磐線、山手線、東武東上線")
la3_2 = ctk.CTkLabel(fr_mode3, text="乗車区間を入力してください。", font=font_body)
en3_2 = ctk.CTkEntry(fr_mode3, width=250, placeholder_text="例：北千住→日暮里→池袋→高坂")
la3_3 = ctk.CTkLabel(fr_mode3, text="要望する合計金額を入力してください。", font=font_body)
en3_3 = ctk.CTkEntry(fr_mode3, width=250, placeholder_text="例：10,000")
la3_4 = ctk.CTkLabel(fr_mode3, text="合計金額の内訳を入力してください。", font=font_body)
en3_4 = ctk.CTkEntry(fr_mode3, width=250, placeholder_text="例：往復1,000円　×10名")
la3_5 = ctk.CTkLabel(fr_mode3, text="使用予定日を入力してください。", font=font_body)
en3_5 = ctk.CTkEntry(fr_mode3, width=250, placeholder_text="例：1月31日")
la3_6 = ctk.CTkLabel(fr_mode3, text="使用理由を入力してください。", font=font_body)
te3_1 = ctk.CTkTextbox(fr_mode3, width=600, height=60, font=font_body)

# fr_mode4に配置する入力関連ウィジェットの作成
la4_1 = ctk.CTkLabel(fr_mode4, text="使用する車種を入力してください。", font=font_body)
en4_1 = ctk.CTkEntry(fr_mode4, width=250, placeholder_text="例：乗用自動車")
la4_2 = ctk.CTkLabel(fr_mode4, text="合計見積金額を入力してください。", font=font_body)
en4_2 = ctk.CTkEntry(fr_mode4, width=250, placeholder_text="例：50,000")
la4_3 = ctk.CTkLabel(fr_mode4, text="ガソリン代の見積金額を入力してください。", font=font_body)
en4_3 = ctk.CTkEntry(fr_mode4, width=250, placeholder_text="例：20,000")
la4_4 = ctk.CTkLabel(fr_mode4, text="高速道路代の見積金額を入力してください。", font=font_body)
en4_4 = ctk.CTkEntry(fr_mode4, width=250, placeholder_text="例：5,000")
la4_5 = ctk.CTkLabel(fr_mode4, text="使用予定日を入力してください。", font=font_body)
en4_5 = ctk.CTkEntry(fr_mode4, width=250, placeholder_text="例：1月31日")
la4_6 = ctk.CTkLabel(fr_mode4, text="乗車経路（往復）を入力してください。", font=font_body)
en4_6 = ctk.CTkEntry(fr_mode4, width=600, placeholder_text="例：北千住→東京電機大学埼玉鳩山キャンパス")
la4_7 = ctk.CTkLabel(fr_mode4, text="使用理由を入力してください。", font=font_body)
te4_1 = ctk.CTkTextbox(fr_mode4, width=600, height=60, font=font_body)
...
te3_1.grid(column=0, row=6, sticky="w", columnspan=2, pady=5)


# fr_mode4に配置する入力関連ウィジェットの配置
la4_1.grid(column=0, row=0, sticky="w", pady=5)
en4_1.grid(column=1, row=0, sticky="e", pady=5)
la4_2.grid(column=0, row=1, sticky="w", pady=5)
en4_2.grid(column=1, row=1, sticky="e", pady=5)
la4_3.grid(column=0, row=2, sticky="w", pady=5)
en4_3.grid(column=1, row=2, sticky="e", pady=5)
la4_4.grid(column=0, row=3, sticky="w", pady=5)
en4_4.grid(column=1, row=3, sticky="e", pady=5)
la4_5.grid(column=0, row=4, sticky="w", pady=5)
en4_5.grid(column=1, row=4, sticky="e", pady=5)
la4_6.grid(column=0, row=5, sticky="w", pady=5)
en4_6.grid(column=0, row=6, sticky="e", columnspan=2, pady=5)
la4_7.grid(column=0, row=7, sticky="w", pady=5)
te4_1.grid(column=0, row=8, sticky="w", columnspan=2, pady=5)
...
bu_change2 = ctk.CTkButton(fr_button1, text="交通費（複数経路）",
...
bu_change3 = ctk.CTkButton(fr_button1, text="交通費（同一経路）",
                           font=("游ゴシック", 20, "bold"), text_color="black",
                           width=200, height=40, corner_radius=0, border_width=1,
                           fg_color="white", hover_color="whitesmoke", text_color_disabled="white",
                           command=button_change3)
bu_change4 = ctk.CTkButton(fr_button1, text="レンタカー",
                           font=("游ゴシック", 20, "bold"), text_color="black",
                           width=150, height=40, corner_radius=0,  border_width=1,
                           fg_color="white", hover_color="whitesmoke", text_color_disabled="white",
                           command=button_change4)
...
bu_change4.grid(column=3, row=0, padx=10)
